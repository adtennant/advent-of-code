...
9 geodes, so its quality level is _`9`_. The second blueprint has ID 2 and can open 12 geodes, so its quality level
is _`24`_. Finally, if you _add up the quality levels_ of all of the blueprints in the list, you get _`33`_.
